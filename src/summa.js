        ...
        .then(function (pdf) {
            ...
            for (var i = 1; i <= totalPages; i++) {
                ...
                if (i > 1 && !headerAdded) {
                    ...
                    pdf.rect(0.5, -1, 0, 0.5, "F");
                    pdf.text("Roll No", 1.2, 0.6);
                    pdf.text("Name", 2.6, 0.6);
                    pdf.text("In Date", 3.8, 0.6);
                    pdf.text("In Time", 5.2, 0.6);
                    pdf.text("Out Date", 6.55, 0.6);
                    pdf.text("Out Time", 7.9, 0.6);
                    pdf.text("Status", 9.3, 0.6);
                    headerAdded = true;
                }
            }
        })
